...
public class jingdong_api {
    ...
    public static List<product> parseProductsFromJson(JSONObject json) {
        ...
        try {
            System.out.println("JD API Response: " + json.toString());
            ...
            for (int i = 0; i < items.length(); i++) {
                ...
                p.setSpecification(item.optString("seller", ""));
                
                JSONObject priceHistory = new JSONObject();
                priceHistory.put("current", item.getString("price"));
                priceHistory.put("original", item.getString("price"));
    ...
    public static void main(String[] args) throws IOException, JSONException {
        ...
        String url = "https://api-gw.onebound.cn/jd/item_search/?key=t3858097232&secret=72323c5f&q=女装&start_price=0&end_price=0&page=1&cat=0&discount_only=&sort=&seller_info=no&nick=&seller_info=&nick=&ppath=&imgid=&filter=";
